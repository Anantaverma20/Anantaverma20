...
pip install streamlitimport streamlit as st st.title('Streamlit App Demo')
st.header('Header')
st.subheader('Sub Header')
st.text('Welcome to the Streamlit App') import pickle pickle_out = open("model.pkl", "wb")
